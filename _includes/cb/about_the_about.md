...
- PDF -- > `{% raw %}{% include feature/item-pdf-embed.html objectid="demo_005"  width="50" %}{% endraw %}`

{% include feature/item-pdf-embed.html objectid="demo_005" width="50" %}

#### Include a Video

- Video: `{% raw %}{% include feature/item-video-embed.html objectid="demo_001" %}{% endraw %}`

{% include feature/item-video-embed.html objectid="demo_002" %}
